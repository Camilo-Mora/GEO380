...
```{r}
# "C:/Users/Camilo/Desktop/Data/Countries_GDP.csv"
```
...
```{r}
# read.csv("C:/Users/Camilo/Desktop/Data/Countries_GDP.csv")
```
...
```{r}
GDPData=read.csv("C:/Users/Camilo/Desktop/Data/Countries_GDP.csv")
```
...
<iframe src="https://mora.shinyapps.io/QuestionsChapter3/" width="100%" height="200px">
</iframe>
...
library(dplyr)            #next I load the package into the current section of R.
```
...
<iframe src="https://mora.shinyapps.io/Quiz_4/" width="100%" height="3000px">
</iframe>
