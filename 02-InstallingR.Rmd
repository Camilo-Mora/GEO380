...
There is also a very popular GUI (Graphical User Interface) called R-Studio, which you can download from [here](https://rstudio.com/products/rstudio/download/); use the free version. 

For the purpose of this class, we will astart with basic R and Tinn-R. I want you to know the insides of R, and later on if you like you can move to use user interfaces that simplify things, but that may also hide things you should know.


Click on the Tinn-R icon (see arrow in image below). Once there, click on "File", then on "New". This will create a clean sheet for you to start writing your codes. You will use this type of sheets to save your codes, as you move along.
