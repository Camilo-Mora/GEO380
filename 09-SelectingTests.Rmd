...
plot(GasA, main=NA,xlim=c(0.7, 1.4),ylim=c(0, 1400),breaks = breaks, xlab = "Dispensed gas volume for a reported 1 gallon (in gallons)",ylab = "Number of trials" ,col=LightBlue)
