...
Next, you scroll-down column one until the sample size in the table makes ours (that is 5). At that row, if you look over the value in the second column, that is the coeficient of correlation of any two random variables with five points. In our case, that value is 0.81. 
Our correlation coeficients was larger , $r$=`r round(r,2)`, meaning that it is unlikley our correlation could occure by chance alone.

There you have it. The more time you study the better grades you get, now demonstrated mathematically.
...
(c) Was it significant?


Place the figure in a Word document and email it as a homework
