...
```{block2, type='rmdtip'}
**LEARNING OBJECTIVES**: 
In this class it is expected that students will gain an ability to develop research questions that can be quantitatively tested. In doing so the student will develop skills to collect, analyze, interpret and graphically present  data, while being able to operate a set of data-analysis software.
```
...
<!--chapter:end:00-Expectations.Rmd-->
...
<!--chapter:end:01-ScientificMethod.Rmd-->
...
## R-Studio {-}
There is a very popular GUI (Graphical User Interface) called R-Studio, which allows you to run R while having a user friendly interface.
...
<!--chapter:end:02-InstallingR.Rmd-->
...
<!--chapter:end:03-RBasics-DataManipulation.Rmd-->
...
<!--chapter:end:04-RBasics-Plots.Rmd-->
...
<div id="h5p-container-9"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-9"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/09_qustion-9'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-11"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-11"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/11_symbol-sample-mean-11'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-10"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-10"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/10_standard-deviation-10'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-6"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-6"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/06_itns-03-glossary-part-ii-6'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-5"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-5"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/05_itns-03-distribution-shapes-5'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
Now lets check some equations. Drag the names to the correct equations for central tendency and dispersion

<div id="h5p-container-12"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-12"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/12_equations-central-tendency-and-dispersion-12'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-7"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/07_terms-7'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
By eye alone, pair the r with the most likely scatterplot

<div id="h5p-container-13"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-13"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/13_by-eye-alone-pair-the-r-with-the-most-likely-scatterplot-13'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-14"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-14"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/14_correlation-units-14'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
Name the elements in the plot

<div id="h5p-container-15"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-15"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/15_name-the-elements-in-the-plot-15'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-16"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-16"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/16_name-the-relationship-types-16'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-17"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-17"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/17_name-the-equations-17'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-18"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-18"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/18_intercept-18'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-19"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-19"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/19_regression-plot-19'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-20"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-20"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/20_lm-20'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-21"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-21"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/21_summary-results-21'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-22"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-22"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/22_summary-results-2-22'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
Pair element of the linear model output in 

<div id="h5p-container-23"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-23"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/23_pair-element-of-the-linear-model-output-in-r-23'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-24"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-24"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/24_about-the-slope-of-a-linear-model-lm-in-r-24'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-25"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-25"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/25_about-the-slope-of-a-linear-model-lm-in-r-2-25'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-26"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-26"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/26_about-the-significance-of-a-linear-model-lm-in-r-26'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-27"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-27"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/27_about-the-coeficient-of-determination-of-a-linear-model-lm-in-r-27'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
```{r, out.width = "70%", echo= FALSE, fig.align = 'center',fig.cap = 'Rejecting the extremes or special'}
...
```{r, out.width = "80%", echo= FALSE, fig.align = 'center',fig.cap = 'Fraction of population beyond 2SD l'}
...
```{block2, type='rmdimportant'}
P-VALUE is the fraction of individuals in a population as extreme as or more extreme than an observed sample
...
```
So one sample burger from a population with a mean of 1500 and a standard deviation, SD, of 50 is $`r round(mean (RandomSample1),2)`$.
...
<div id="h5p-container-28"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-28"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/28_pair-the-correst-tests-and-alphas-28'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
Deciding of a conclusion

<div id="h5p-container-29"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-29"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/29_deciding-of-a-conclusion-29'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-30"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-30"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/30_deciding-of-a-conclusion-2-30'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-31"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-31"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/31_select-right-test-31'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-32"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-32"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/32_select-right-test-2-32'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-33"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-33"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/33_select-right-test-3-33'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-34"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-34"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/34_error-types-34'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-35"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-35"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/35_error-type-35'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<div id="h5p-container-36"></div> 
<script>
  (function() {
    let h5pContainer = document.getElementById("h5p-container-36"); // div tag ID
    let h5pJsonPath = 'H5P_Unzip/36_draw-a-conclusion-36'; // YOUR H5P FILE (THIS IS A FOLDER PATH)
...
<!--chapter:end:09-SelectingTests.Rmd-->
...
<!--chapter:end:10-OneSampleTests.Rmd-->
...
<!--chapter:end:11-TwoSampleTests.Rmd-->
...
<!--chapter:end:12-MultipleSampleTest.Rmd-->
...
<!--chapter:end:13-FinalProject.Rmd-->
